...
export default function NovoAgendamento() {
  ...
  async function gerar(e) {
    ...
    setSalvando(true)
    try {
      const { data } = await api.post('/api/agendamentos', form)
    ...
    <div className="p-4 sm:p-6 max-w-xl mx-auto">
      <div className="bg-white rounded-xl shadow p-6">
        ...
        <div className="flex gap-3 mt-3">
          ...
          <button onClick={() => { setLinkGerado(null); setForm({ portariaId: '', departamento: '', pedidoInterno: '', observacoes: '' }) }}
    ...
    <div className="p-4 sm:p-6 max-w-xl mx-auto">
      ...
      <form onSubmit={gerar} className="bg-white rounded-xl shadow p-6 space-y-4">
        <div>
          ...
          <select name="portariaId" value={form.portariaId} onChange={handle} required
        ...
        <div>
          ...
          <select name="departamento" value={form.departamento} onChange={handle} required
            className="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
